...
void Process_Socket_Data(SOCKET s)
{
	...
	u8 ValveSet_Value[12];  //À´×ÔÍøÂç´«Èë¹ıÀ´µÄĞÅºÅ
	u8 i;
	////////////////////////////////////////////////////////
	...
	if (Rx_Buffer[0]==0x04) //±¾»úµÄÉè±¸µØÖ·Îª0x00 04 
	{
		printf("\r\nSLocal Address ok!\r\n");
		...
		switch (Rx_Buffer[1])
		{
			...
			*********************************************/
			...
			ValveStateChange(ValveSet_Value);//ÍøÂçĞÅºÅ´«Èë¹ıÀ´µÄ¿ª¶ÏĞÅÏ¢£¬È»ºó³ÌĞòÊµÏÖ×Ô¶¯ÉèÖÃ¶ÔÓ¦µÄIOµÄ¸ßµÍµçÆ½£¬Êµ¼Ê¸Ä±äIO¿ÚÉè¶¨Öµ
