...
void ValveState_Init()    //¶Ë¿Ú³õÊ¼»¯
{
  ...
  // SystemInit();   //ÏµÍ³Ê±ÖÓ³õÊ¼»¯  we donnot need to init again
...
* Description  : if we want to update the status, we need to call this funtion to make this changeã€‚TO actual change the valve
* Input :None 
* Output  :  None
* Return Value :  None
