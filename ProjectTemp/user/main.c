...
//        delay_us(2000000); 
        ...
        if (sendcount<=40000)
        {
            ...
            Write_SOCK_Data_Buffer(0, Tx_Buffer,4);//鎸囧畾Socket(0~7)鍙戦�佹暟鎹鐞?绔彛0鍙戦�?3瀛楄妭鏁版嵁

            //memcpy(Tx_Buffer, "", 23);
            //Write_SOCK_Data_Buffer(0, Tx_Buffer, 23);//鎸囧畾Socket(0~7)鍙戦�佹暟鎹鐞?绔彛0鍙戦�?3瀛楄妭鏁版嵁

            //Write_SOCK_Data_Buffer(0, Tx_Buffer,a);//鎸囧畾Socket(0~7)鍙戦�佹暟鎹鐞?绔彛0鍙戦�?3瀛楄妭鏁版嵁
        }
        else
        {
            sendcount=0;
